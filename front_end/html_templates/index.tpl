...
<div class="panel-group" id="accordion">
  <div class="panel panel-default">
    ...
    <div class="row featurette featureImagePad">
            ...
            % if len(name) > 13:
                  <h3 class="featurette-heading">{{name}}</h3>
            % else:
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-xs-12 col-sm-6 col-md-6 imageLower">
                <img src="/images/icons/steam.png">
              </div>
              <div class="col-xs-12 col-sm-5 col-md-6 buttonLower">
                <a target="_blank" href="{{steam_URL}}" class="btn btn-primary btn-lg" role="button" data-toggle="tooltip" data-placement="bottom" title="Current handle on steam.">Steam</a>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-6 col-sm-5 col-md-6 buttonLower">
                <a target="_blank" href="{{discord_username}}" class="btn btn-primary btn-lg" role="button" data-toggle="tooltip" data-placement="bottom" title="Discord username <3.">Discord</a>
              </div>
            </div>
          </div>
        </div>
